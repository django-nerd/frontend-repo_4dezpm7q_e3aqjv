export default function NoiseBG() {
  ...
  return (
    <div
      className="pointer-events-none fixed inset-0 -z-10 opacity-[0.06] mix-blend-soft-light dark:opacity-[0.08]"
      style={{ backgroundImage: dataUrl, backgroundSize: '160px 160px' }}
    />
  );
}
